...
@Component({
  selector: 'app-sociedades-card',
  templateUrl: './sociedades-card.component.html',
  styleUrls: ['./sociedades-card.component.scss'],
  animations: [
...
export class SociedadesCardComponent implements OnInit {  bounceInUp: any;
  bounceInLeft: any;
  bounceInRight: any;
  bounceInDown: any;
  fadeInLeft: any;
